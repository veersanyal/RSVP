  ...
  <div class="container px-5 py-12 mx-auto" style="cursor: auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      >
        ...
        >
          <div class="flex">
            <span class="mr-3">{{ props.optiongroups[0] }}</span>
            <button
          ...
          <div class="flex ml-6 items-center">
            <span class="mr-3">{{ props.optiongroups[1] }}</span>
            <div class="relative">
              <select
...
const props = defineProps({
  imageURL: {
    type: String,
    default: "https://stackdiary.com/140x100.png",
  },
  altText: { type: String, default: "eCommerce" },
  tag: { type: String, default: "ON SALE" },
  title: { type: String, default: "Blue Dress v2" },
  reviewcount: { type: Number, default: 20 },
  optiongroups: { type: Array, default: () => ["Color", "Size"] },
  price: { type: Number, default: 19.99 },
  ctaprimary: { type: String, default: "Add to Cart" },
  description: {
    type: String,
    default:
